...
class CategoryWiseBookPagingSource constructor(val remoteDataSources: RemoteDataSources, val categoryID : String = "", val searchBy : String = "") : PagingSource<Int, BookItem>() {
