...
class SearchStoryPagingSource constructor(val remoteDataSources: RemoteDataSources, val searchKey : String) : PagingSource<Int, BookItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, BookItem> {
        return try {
            ...
            val data = remoteDataSources.getStoryBySearch(page = page, searchKey = searchKey)
            LoadResult.Page(
