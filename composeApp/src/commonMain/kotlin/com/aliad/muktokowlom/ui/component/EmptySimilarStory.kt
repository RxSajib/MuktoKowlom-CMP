...
import muktokowlomcmp.composeapp.generated.resources.matching_story_notfound_details
...
@Composable
fun EmptySimilarStory(modifier: Modifier, retryAgain : () -> Unit){
    Column(modifier = modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(
            text = stringResource(Res.string.matching_story_notfound_details),
            modifier = Modifier.fillMaxWidth(),
            textAlign = TextAlign.Center,
            style = MaterialTheme.typography.titleSmall.copy(
...
@Preview
@Composable
fun EmptySimilarStoryPreview(){
    EmptySimilarStory(modifier = Modifier){
