    ...
    Row {
        for (i in 1..maxRating) {
            if (i <= rating.toInt()) {
                ...
                // Partial star
                _root_ide_package_.com.aliad.muktokowlom.ui.component.PartialStar(fraction = rating % 1)
            } else {
                // Empty stars
                Icon(
                    painterResource(Res.drawable.ic_round_star),
...
private fun PartialStar(fraction: Float) {
    val customShape =
        _root_ide_package_.com.aliad.muktokowlom.ui.component.FractionalClipShape(fraction)
