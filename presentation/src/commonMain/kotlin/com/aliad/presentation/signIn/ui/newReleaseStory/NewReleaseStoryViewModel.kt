package com.aliad.presentation.signIn.ui.newReleaseStory
...
class NewReleaseStoryViewModel constructor(val storyTypeUseCase: StoryTypeUseCase) : ViewModel() {

    var searchStoryData by mutableStateOf("")

    val storyData = storyTypeUseCase.getStoryType(searchKey = "All", searchType = StoryType.NEW_STORY.name)
