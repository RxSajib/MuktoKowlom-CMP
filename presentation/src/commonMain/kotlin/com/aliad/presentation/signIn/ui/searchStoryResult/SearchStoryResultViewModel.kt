...
class SearchStoryResultViewModel constructor(val searchBookUseCase: SearchBookUseCase) : ViewModel() {

    var searchStoryData by mutableStateOf("")

    val searchStory = searchBookUseCase.searchStory(searchKey = "Abdulloh").cachedIn(viewModelScope)
